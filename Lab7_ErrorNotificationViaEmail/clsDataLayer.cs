    ...
    public class clsDataLayer
    {
        ...
        string PayRate, string StartDate, string EndDate)
        {
            ...
            try
            {
                ...
                command.ExecuteNonQuery();
                // UPDATE to save the PayRate, StartDate, and EndDate into the new record.
            ...
            {
                // myTransaction will rollback if entered invalid
        ...
        public static bool SaveUser(string Database, string UserName, string Password, string SecurityLevel)
        {
            ...
            try
            {
                ...
                // Saving all data into tblUserLogin
