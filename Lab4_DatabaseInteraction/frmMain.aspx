...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" Height="1300px" Width="500px">
                ...
                <br />
                <br />
                <asp:ImageButton ID="ImageButton8" runat="server" Height="162px" ImageUrl="~/Images/ediEmployee.png" PostBackUrl="~/frmEditPersonnel.aspx" Width="190px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton6" runat="server" PostBackUrl="~/frmEditPersonnel.aspx">Edit Employees</asp:LinkButton>
            </asp:Panel>
        </div>
    </form>
</body>
